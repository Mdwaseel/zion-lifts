/**
 * The three policy pages, at /privacy, /terms and /cookies.
 *
 * Each clause carries its own `id`. That is not decoration: the page builds
 * `#clause-<id>` anchors for the sticky contents list and observes those
 * elements to highlight the section you are reading, so an id that is missing
 * or duplicated breaks the navigation rather than just the markup.
 *
 * `effective_date` is an ISO date the page formats for display. Change it when
 * the wording changes — a policy whose text moved but whose date did not is
...
const LEGAL_PAGES = [
    ...
    clauses: [
      {
        ...
        body:
          ...
          "Telangana, India. In this policy, 'we' and 'us' mean Zion Lifts Pvt. Ltd. If you have " +
          'any question about this policy, write to info@zionlifts.com.',
      },
      {
        id: 'what-we-collect',
      ...
      {
        id: 'drawings-and-attachments',
        heading: 'Drawings and attachments',
        body:
  ...
  },
  {
    ...
    clauses: [
      ...
      {
        id: 'about-the-information-here',
        heading: 'About the information here',
        body:
      ...
      {
        id: 'specifications-are-indicative',
        heading: 'Specifications are indicative',
        body:
      ...
      {
        id: 'enquiries-you-submit',
        heading: 'Enquiries you submit',
        body:
...
/** One policy page by slug. Undefined for a slug we do not publish. */
